...
public class World {
    ...
    private void updatePlatforms(float deltaTime) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (platform.state == Platform.PLATFORM_STATE_PULVERIZING && platform.stateTime > Platform.PLATFORM_STATE_PULVERIZE_TIME) {
    ...
    private void checkSquirrelsCollisions() {
        int len = squirrels.size();
        for (int i = 0; i < len; i++) {
            Squirrel squirrel = squirrels.get(i);
