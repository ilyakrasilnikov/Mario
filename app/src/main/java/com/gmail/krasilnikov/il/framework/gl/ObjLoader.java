        ...
        try {
            ...
            for (int i = 0; i < lines.size(); i++) {
                ...
                if (line.startsWith("v ")) {
                    ...
                    vertices[vertexIndex + 0] = Float.parseFloat(tokens[1]);
                ...
                if (line.startsWith("vn ")) {
                    String[] tokens = line.split("[ ]+");
                    normals[normalIndex + 0] = Float.parseFloat(tokens[1]);
                ...
                if (line.startsWith("vt ")) {
                    String[] tokens = line.split("[ ]+");
                    uv[uvIndex + 0] = Float.parseFloat(tokens[1]);
