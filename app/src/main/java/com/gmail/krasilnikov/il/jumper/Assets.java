...
public class Assets {
    ...
    public static void load (GLGame game) {
        background = new Texture(game, "SuperJumper/sj_background.png");
        backgroundRegion = new TextureRegion(background, 0, 0, 320, 480);
        items = new Texture(game, "SuperJumper/sj_items.png");
        ...
        music = game.getAudio().newMusic("SuperJumper/sj_music.mp3");
        music.setLooping(true);
        music.setVolume(0.5f);
        if (Settings.soundEnabled)
            music.play();
        jumpSound = game.getAudio().newSound("SuperJumper/sj_jump.ogg");
        highJumpSound = game.getAudio().newSound("SuperJumper/sj_highjump.ogg");
        hitSound = game.getAudio().newSound("SuperJumper/sj_hit.ogg");
        coinSound = game.getAudio().newSound("SuperJumper/sj_coin.ogg");
        clickSound = game.getAudio().newSound("SuperJumper/sj_click.ogg");
    };
