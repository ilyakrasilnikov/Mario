...
public class Camera2DTest extends GLGame{
    ...
    class Camera2DScreen extends Screen {
        ...
        public Camera2DScreen(Game game) {
            ...
            cannon = new Cannon(FloatMath.sqrt(3) / 4, 0.5f, FloatMath.sqrt(3) / 2, 1);
            ...
            cannonVertices.setVertices(new float[] {-FloatMath.sqrt(3) / 4, -0.5f,
                                                     FloatMath.sqrt(3) / 4,  0f,
                                                    -FloatMath.sqrt(3) / 4,  0.5f}, 0, 6);
        ...
        public void update(float deltaTime) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                if (event.type == Input.TouchEvent.TOUCH_UP) {
                    ...
                    float ballSpeed = touchPos.len() * 1;
