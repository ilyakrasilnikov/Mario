...
public class WorldRenderer {
    ...
    static final float FRUSTUM_HEIGTH = 15;
    ...
    public WorldRenderer(GLGraphics glGraphics, SpriteBatcher batcher, World world) {
        ...
        this.world = world;
        this.cam = new Camera2D(glGraphics, FRUSTUM_WIDTH, FRUSTUM_HEIGTH);
    ...
    public void renderBackground() {
        ...
        batcher.drawSprite(cam.position.x, cam.position.y, FRUSTUM_WIDTH, FRUSTUM_HEIGTH, Assets.backgroundRegion);
        batcher.endBatch();
    }
