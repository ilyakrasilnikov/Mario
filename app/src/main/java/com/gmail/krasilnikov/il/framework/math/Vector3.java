package com.gmail.krasilnikov.il.framework.math;
...
public class Vector3 {
    ...
    public Vector3 rotate(float angle, float asisX, float asisY, float asisZ) {
        inVec[0] = x;
        inVec[1] = y;
        inVec[2] = z;
        inVec[3] = 1;
        Matrix.setIdentityM(matrix, 0);
        Matrix.rotateM(matrix, 0, angle, asisX, asisY, asisZ);
